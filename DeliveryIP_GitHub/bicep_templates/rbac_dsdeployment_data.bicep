...
resource r_dataLakeRoleAssignmentPurview 'Microsoft.Authorization/roleAssignments@2022-04-01' = if (DeployPurview == 'True') {
...
resource r_landingStorageRoleAssignmentPurview 'Microsoft.Authorization/roleAssignments@2022-04-01' = if (DeployPurview == 'True') {
...
resource r_EventHubSharedServiceAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = if (DeployEventHubNamespace == 'True') {
  name: guid(Entra_Group_Shared_Service_Group_ID, r_eventHubNamespace.name)
...
resource r_StreamAnalyticsSharedServiceAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = if (DeployStreamAnalytics == 'True') {
  name: guid(Entra_Group_Shared_Service_Group_ID, r_StreamAnalytics.name)
