...
import { getCookiePolicyUserChoice, wcpCookieConsentInit } from "./components/cookiesPolicy/cookiePolicyBanner";
import { SnackbarProvider } from "notistack";
import { SnackbarSuccess } from "./components/snackbar/snackbarSuccess";
import { SnackbarError } from "./components/snackbar/snackbarError";

wcpCookieConsentInit();

/* Application insights initialization */
const reactPlugin: ReactPlugin = Telemetry.initAppInsights(window.ENV.APP_INSIGHTS_CS, getCookiePolicyUserChoice());
