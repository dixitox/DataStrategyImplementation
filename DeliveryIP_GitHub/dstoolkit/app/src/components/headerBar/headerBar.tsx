...
export function HeaderBar({ location }: { location?: NavLocation }) {
    ...
    const navItems: (NavItem | null)[] = useMemo(
        () => [
            ...
            {
                key: "assets",
                label: t("components.header-bar.assets"),
                isPrimary: true,
                location: NavLocation.Assets,
                to: "/search",
            },
            isAdmin || isProducer
                ? {
                ...
                : null,
            window.ENV?.RUN_FLAGS.includes(RunFlags.BlogEnabled)
                ? {
                      key: "blog",
                      label: t("components.header-bar.blog"),
                      isPrimary: true,
                      location: NavLocation.Blog,
                      to: "/blog",
                  }
                : null,
            window.ENV?.RUN_FLAGS.includes(RunFlags.DsToolkitNav)
                ? {
                      key: "dstoolkit",
                      label: t("components.header-bar.dstoolkit-link"),
                      isPrimary: true,
                      externalNav: "https://www.ds-toolkit.com",
                      target: "_blank",
                  }
                : null,
            !isAuthenticated
            ...
            isAdmin || isProducer
                ? {
                      key: "manage-assets",
                      label: t("components.header-bar.manage-assets"),
                      isPrimary: false,
                      location: NavLocation.Manage,
                      to: "/manage",
                  }
                : null,
            isAdmin
                ? {
                      ...
                      label: t("components.header-bar.analytics-report"),
                      isPrimary: false,
                      location: NavLocation.AnalyticsReport,
                      to: "/analytics-report",
                  }
                : null,
            isAuthenticated
        ...
        <>
            <div className="flex items-center justify-between">
                <div className="flex items-center">
                    <img
                        className="h-[22px] w-[98px] object-contain object-left"
